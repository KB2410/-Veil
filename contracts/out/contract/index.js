...
const _descriptor_2 = new __compactRuntime.CompactTypeVector(5, _descriptor_1);
      ...
      addEligible: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('addEligible',
                                     ...
                                     'veil_feedback.compact line 27 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      submit: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submit',
                                     'argument 1 (as invoked from Typescript)',
                                     'veil_feedback.compact line 39 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(rating_0),
      ...
      getTallies: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getTallies',
                                     'argument 1 (as invoked from Typescript)',
                                     'veil_feedback.compact line 58 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  _localSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('localSecret',
                                 'return value',
                                 'veil_feedback.compact line 18 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _credential_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('credential',
                                 'return value',
                                 'veil_feedback.compact line 19 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _submit_0(context, partialProofData, rating_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    if (this._equal_2(disclosedRating_0, 1n)) {
      const tmp_0 = 1n;
      __compactRuntime.queryLedgerState(context,
                                        partialProofData,
                                        [
    ...
    if (this._equal_3(disclosedRating_0, 2n)) {
      const tmp_1 = 1n;
      __compactRuntime.queryLedgerState(context,
                                        partialProofData,
                                        [
    ...
    if (this._equal_4(disclosedRating_0, 3n)) {
      const tmp_2 = 1n;
      __compactRuntime.queryLedgerState(context,
                                        partialProofData,
                                        [
    ...
    if (this._equal_5(disclosedRating_0, 4n)) {
      const tmp_3 = 1n;
      __compactRuntime.queryLedgerState(context,
                                        partialProofData,
                                        [
    ...
    if (this._equal_6(disclosedRating_0, 5n)) {
      const tmp_4 = 1n;
      __compactRuntime.queryLedgerState(context,
                                        partialProofData,
                                        [
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'veil_feedback.compact line 10 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    usedNullifiers: {
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'veil_feedback.compact line 11 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
